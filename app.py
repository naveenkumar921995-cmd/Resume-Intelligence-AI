...
PAGE_ROUTES = {
    ...
    "📊 ATS Analysis": ats_analysis_page,
    "🤖 Machine Learning": ml_prediction_page,
    "🧬 Deep Learning": deep_learning_page,
    "🎯 Recruiter Dashboard": recruiter_dashboard_page,
    "💼 Salary Prediction": salary_prediction_page,
    "📚 Learning Roadmap": learning_roadmap_page,
    "💬 AI Career Coach": ai_career_coach_page,
    "🎤 Interview Generator": interview_generator_page,
    "📜 Cover Letter": cover_letter_page,
    "📧 Email Generator": email_generator_page,
    "📑 Executive Report": executive_report_page,
